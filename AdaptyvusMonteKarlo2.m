%function [fMin2visi,vidurkis] = AdaptyvusMonteKarlo2(funkcija,a1,b1)
function [fMax2visi,fMin2visi,vidurkis] = AdaptyvusMonteKarlo2(funkcija,a1,b1)
...
%[fMax2visi, fMin2visi, VidMin] = AdaptyvusMonteKarlo2(funkcija,a1,b1)
fMin2visi=[];
fMax2visi=[];
for k=1:10
